...
import yogi.com.translateapp.ui.Dialog;
...
public class TwilioActivity extends AppCompatActivity implements DeviceListener, ConnectionListener {

    private static final String TAG = TwilioActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        clientProfile = new ClientProfile("Yogi Sikri", true, true);
        ...
        if (!Twilio.isInitialized()) {
            Twilio.initialize(getApplicationContext(), new Twilio.InitListener() {
                ...
                public void onError(Exception e) {
                    ...
                    Toast.makeText(TwilioActivity.this, "Failed to initialize the Twilio Client SDK", Toast.LENGTH_LONG).show();
                }
            });
        }
    }
    ...
    private void createDevice(String capabilityToken) {
        try {
            ...
            if (clientDevice == null) {
                ...
                Intent intent = new Intent(getApplicationContext(), TwilioActivity.class);
            ...
            clientNameTextView.setText("Client Name: " + TwilioActivity.this.clientProfile.getName());
            ...
            outgoingCapabilityTextView.setText("Outgoing Capability: " +Boolean.toString(TwilioActivity.this.clientProfile.isAllowOutgoing()));
            ...
            incomingCapabilityTextView.setText("Incoming Capability: " +Boolean.toString(TwilioActivity.this.clientProfile.isAllowIncoming()));
            ...
            Toast.makeText(TwilioActivity.this, "Device error", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void resetUI() {
        ...
        muteActionFab.setImageDrawable(ContextCompat.getDrawable(TwilioActivity.this, R.drawable.ic_mic_green_24px));
        speakerActionFab.setImageDrawable(ContextCompat.getDrawable(TwilioActivity.this, R.drawable.ic_speaker_off_black_24dp));
    ...
    private View.OnClickListener muteMicrophoneFabClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (muteMicrophone) {
                    muteActionFab.setImageDrawable(ContextCompat.getDrawable(TwilioActivity.this, R.drawable.ic_mic_off_red_24px));
                } else {
                    muteActionFab.setImageDrawable(ContextCompat.getDrawable(TwilioActivity.this, R.drawable.ic_mic_green_24px));
                }
            }
    ...
    private View.OnClickListener toggleSpeakerPhoneFabClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (speakerPhone) {
                    speakerActionFab.setImageDrawable(ContextCompat.getDrawable(TwilioActivity.this, R.drawable.ic_speaker_on_black_24dp));
                } else {
                    speakerActionFab.setImageDrawable(ContextCompat.getDrawable(TwilioActivity.this, R.drawable.ic_speaker_off_black_24dp));
                }
            }
